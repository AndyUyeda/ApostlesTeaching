...
+ (void)showToastInParentView: (UIView *)parentView withText:(NSString *)text withDuaration:(float)duration withOffset: (float)offset;
{
    ...
    float yOrigin = parentFrame.size.height - (70.0 + ToastHeight * toastsAlreadyInParent + ToastGap * toastsAlreadyInParent) - offset;
